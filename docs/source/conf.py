...
import sys, os
# Insert the current folder in the syspath, so that ``settings`` will be imported.
sys.path.insert(0, os.path.abspath('.'))
# Insert the grandparent folder in the syspath, so that ``icetea`` will become readable from sphinx
sys.path.insert(0, os.path.abspath('../../'))
import settings
